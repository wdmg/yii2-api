...
<?php $this->registerJs(
    ...
    if ($form.length > 0) {
        /*function testApiFormAfterValidate(event, attribute, messages) {*/
            $form.find(\'#sendRequest\').on(\'click\', function() {
                ...
                $.ajax({
                        ...
                        if(data) {
                            ...
                            if (data.status == 200) {
                                if(data.responseJSON) {
                                    $(\'#testApiResponse\').text(JSON.stringify(data.responseJSON, null, 2));
                                }
                            }
                        }
                    ...
                    error: function(data) {
                        ...
                        console.log(\'Request error\' + json.error);
                    }
                });
                return false;
            });
        /*}
        $form.on("afterValidateAttribute", testApiFormAfterValidate);*/
